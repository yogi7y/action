...
ALTER TABLE ONLY "public"."contexts"
    ADD CONSTRAINT "context_name_unique" UNIQUE ("name");
...
ALTER TABLE ONLY "public"."tasks"
    ADD CONSTRAINT "tasks_context_id_fkey" FOREIGN KEY ("context_id") REFERENCES "public"."contexts"("id") ON DELETE SET NULL;
